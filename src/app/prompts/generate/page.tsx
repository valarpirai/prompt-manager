              ...
              <form onSubmit={handleGenerate} className="space-y-6">
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Describe what you want your AI prompt to accomplish (e.g.,
                    &quot;Java code review&quot;, &quot;Creative writing
                    assistant&quot;)
                  </p>
                  <textarea
                    id="description"
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Provide any additional context, requirements, or examples
                    that might help generate a better prompt
                  </p>
                  <textarea
                    id="context"
                    rows={4}
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-sm text-gray-600">
                    {generatedPrompt.originalDescription}
                  </p>
                </div>
                ...
                <div className="flex justify-end space-x-3 mt-6 pt-6 border-t border-gray-200">
                  ...
                  <button
                    onClick={handleSave}
                    disabled={
                      saving || !editedTitle.trim() || !editedPrompt.trim()
                    }
