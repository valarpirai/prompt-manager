...
export default function PromptVersionsPage() {
  ...
  const handleRevert = async (version: number) => {
    if (!confirm(`Are you sure you want to revert to version ${version}? This will create a new version with the reverted content.`)) {
      return
    }
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="space-y-6">
            {versions.map((version) => (
              <div key={version.id} className="bg-white shadow rounded-lg overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200">
                  ...
                  <div className="mt-2 flex items-center space-x-6 text-sm text-gray-500">
                    <span>
                      By {version.creator.display_name || version.creator.email.split('@')[0]}
                    </span>
