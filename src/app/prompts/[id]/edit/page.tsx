                ...
                <div>
                  ...
                  <div className="mt-1 p-3 bg-gray-50 border border-gray-200 rounded-md">
                    <p className="text-sm text-gray-600">
                      Private prompts cannot be assigned to teams. Only you will
                      have access to this prompt.
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-yellow-700">
                      <p>
                        Saving changes will create a new version of this prompt.
                        The previous version will be preserved in the version
                        history.
                      </p>
                    </div>
                  </div>
