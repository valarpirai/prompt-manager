  ...
  const fetchUserPrompts = async (token: string) => {
    try {
      const response = await fetch(
        '/api/prompts?limit=5&sortBy=updated_at&sortOrder=desc',
        {
          headers: {
      ...
      if (response.ok) {
        ...
        const totalUsage = data.prompts.reduce(
          (sum: number, prompt: Prompt) => sum + prompt.usage_count,
          0
        );
        const publicCount = data.prompts.filter(
          (prompt: Prompt) => prompt.visibility === 'PUBLIC'
        ).length;
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <DashboardEmailNotification
            ...
            onVerificationUpdate={(isVerified) => {
              setUser((prev) =>
                prev ? { ...prev, is_verified: isVerified } : null
              );
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-sm text-gray-500">
                        Let AI help you create prompts
                      </p>
                    </div>
                  </Link>
                  ...
                  >
                    ...
                    <div className="ml-3">
                      ...
                      <p className="text-sm text-gray-500">
                        Collaborate with others on prompts
                      </p>
                    </div>
                  </Link>
