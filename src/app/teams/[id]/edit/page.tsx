...
export default function EditTeamPage() {
  ...
  const handleDelete = async () => {
    if (!confirm(`Are you sure you want to delete "${team?.name}"? This action cannot be undone and will remove all team prompts and members.`)) {
      return
    }
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <ul className="list-disc pl-5 space-y-1">
                    <li>Only team admins can edit team information and manage members</li>
                    <li>Deleting a team will remove all associated prompts and member access</li>
                    <li>Team members will lose access to team prompts when the team is deleted</li>
                    <li>Consider transferring important prompts to personal ownership before deletion</li>
                  </ul>
                </div>
              </div>
            </div>
