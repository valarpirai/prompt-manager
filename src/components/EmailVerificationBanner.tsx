          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-yellow-700">
                ...
                email address ({userEmail}) to access all features.
              </p>
              {message && (
                <p
                  className={`text-sm mt-1 ${message.includes('sent') ? 'text-green-600' : 'text-red-600'}`}
                >
                  {message}
                </p>
              )}
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                {isResending && (
                  <svg
                    className="animate-spin -ml-1 mr-2 h-3 w-3 text-yellow-700"
                    fill="none"
                    viewBox="0 0 24 24"
                  >
                    <circle
