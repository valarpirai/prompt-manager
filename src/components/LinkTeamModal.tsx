      ...
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div className="mt-3">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900">Link to Team</h3>
            <button
              onClick={handleClose}
              disabled={loading}
          ...
          <div className="mb-4">
            <p className="text-sm text-gray-600">
              Link &quot;<strong>{promptTitle}</strong>&quot; to a team for
              collaboration.
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  {selectedTeamId
                    ? 'Team members will be able to view and edit this prompt.'
                    : 'Only you will have access to this prompt.'}
                </p>
              </div>
